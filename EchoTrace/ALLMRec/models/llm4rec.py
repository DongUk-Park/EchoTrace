...
class llm4rec(nn.Module):
    def __init__(
        ...
        if llm_model == 'opt':
            self.llm_model = OPTForCausalLM.from_pretrained("/home/parkdw00/models/opt-6.7b", torch_dtype=torch.float16, use_safetensors=True).to("cuda")
            self.llm_tokenizer = AutoTokenizer.from_pretrained("/home/parkdw00/models/opt-6.7b")
