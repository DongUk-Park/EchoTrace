...
class A_llmrec_model(nn.Module):
    def __init__(self, args):
        ...
        with gzip.open(f'/home/parkdw00/Codes/data/{args.rec_pre_trained_data}/{args.rec_pre_trained_data}_text_name_dict.json.gz','rb') as ft:
    ...
    def save_model(self, args, epoch1=None, epoch2=None):
        out_dir = f'/home/parkdw00/Codes/A-LLMRec/models/saved_models/'
        create_dir(out_dir)
    ...
    def load_model(self, args, phase1_epoch=None, phase2_epoch=None):
        out_dir = f'/home/parkdw00/Codes/A-LLMRec/models/saved_models/{args.rec_pre_trained_data}_{args.recsys}_{phase1_epoch}_'
    ...
    def generate(self, data):
        ...
        for i in range(len(text_input)):
            ...
            f = open(f'/home/parkdw00/Codes/A-LLMRec/recommendation_output.txt','a')
    ...
    def generate_solo(self, data, seed):
        ...
        with torch.no_grad():
            ...
            for i in range(len(u)):
                ...
                with open("/home/parkdw00/Codes/A-LLMRec/candidate_debug.jsonl", "a") as f:
