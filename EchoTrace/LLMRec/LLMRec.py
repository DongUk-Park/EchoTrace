...
class Trainer(object):
    def __init__(self, data_config, file_path):
        ...
        self.item_attribute_embedding = pickle.load(open(args.data_path + args.dataset + '/augmented_total_embed_dict','rb')) # i_attr step5
...
def hyper_param_test(data_generator):
    ...
    csv_path = "/home/parkdw00/Codes/LLMRec/LLMRec_c/movielens/ml100k_llmrec_format/output/LightGCN_grid_search_results.csv"
    results = []
...
if __name__ == '__main__':
    ...
    # 저장 경로 설정
    save_path = "/home/parkdw00/Codes/LLMRec/LLMRec_c/movielens/ml100k_llmrec_format/best_candidates_for_feedback_loop.json"
